    ...
    <>
      <div className="min-h-screen bg-gray-100">
        ...
        <div className="container mx-auto py-20 px-4">
          <div className="text-center text-2xl font-bold mb-8 pt-20 lg:pt-2 ">Batch 2020-2025</div>
                ...
                {filteredData.map((Val) => (
                  <tr key={Val.id} className="border-b">
                    ...
                    <td className="py-2 px-4 border text-left">
                      ...
                      <div>
                        <span className="font-thin">{Val.introduction}</span>
                      </div>
                      <div>
                        <span><b>Interests : </b>{Val.intrest}</span>
                      </div>
                      <div>
                        <a
